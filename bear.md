...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  | IC | CB | TB | $\mathrm{HB}_{0}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}^{\mathrm{T} R C B}$ | IC | CB | $\mathrm{HB}_{0}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ |  |
...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  | IC | CB | TB | $\mathrm{HB}_{0}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}^{\mathrm{T} R C B}$ | $\mathrm{CH}^{\mathrm{T} R C B}$ | CB | $\mathrm{HB}_{0}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ | $\mathrm{HB}_{10}^{\mathrm{C} C E}$ |
...
| $Q_{H}^{\text {PO }}$ | 22 | 29 | 49 | 43 | 68 | 90 | 1 | 15.25 | 23.06 | 17.07 | 37.23 | 28.22 |
